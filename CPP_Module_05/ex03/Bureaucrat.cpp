...
/*   Updated: 2022/10/26 15:59:36 by yismaili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Bureaucrat const &brcrat, Form &form) {
	try {
		...
		std::cout << brcrat << " couldn’t sign " << form << " because " << e.what() << std::endl;
		return ;
	}
...
void Bureaucrat::executeForm(Form const & form) {
    ...
    {
        std::cout <<Name<< " cannot execute this form because the "<<e.what()<<std::endl; 
    }
}
