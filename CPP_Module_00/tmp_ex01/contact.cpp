...
/*   Updated: 2022/09/21 20:19:27 by yismaili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "contact.hpp"

contact::contact(std::string FirstName_, std::string LastName_, std::string Nickname_, std::string PhoneNumber_, std::string DarkestSecret_)
{
